  ...
  public: {
    Tables: {
      ...
      event_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_requests_decided_by_fkey"
            columns: ["decided_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      attendee_role: "organizer" | "attendee"
      conversation_type: "direct" | "event"
      event_request_status: "pending" | "approved" | "rejected" | "cancelled"
      ...
      report_target_type: "profile" | "event" | "message"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
